 ...
 */
public class PropertyAutocompleterServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ArrayList<AutocompleteObject> res = new AutocompleteService().getPropertyAutocompleResults(query);
